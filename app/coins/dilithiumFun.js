	...
	items: [
		{
			...
			summary: "Dilithium Genesis Block",
			alertBodyHtml: "This is the first block in the Dilithium blockchain, known as the <b>Genesis Block</b>. This block was mined by Dilithium's creator <b>Satoshi Nakamoto</b>.<br/>Read more here: <a href='https://en.Dilithium.it/wiki/Genesis_block'>Dilithium.it/wiki/Genesis_block</a>.",
			referenceUrl: "https://en.Dilithium.it/wiki/Genesis_block"
		},
		{
			type: "tx",
			date: "2009-01-03",
			...
			alertBodyHtml: "This transaction doesn't really exist! This is the <b>coinbase transaction</b> of the <a href='./block/000000000019d6689c085ae165831e934ff763ae46a2a6c172b3f1b60a8ce26f'>Dilithium Genesis Block</a>. For more background about this special-case transaction, you can read <a href='https://github.com/Dilithium/Dilithium/issues/3303'>this brief discussion</a> among some of the <a href='https://Dilithium.org'>Dilithium</a> developers.",
			referenceUrl: "https://github.com/Dilithium/Dilithium/issues/3303"
		},
		{
			type: "tx",
			date: "2010-07-29",
			...
			alertBodyHtml: "Multiple transactions in Block #71,036, including this one, included MANY OP_CHECKSIG commands, causing nodes to perform unnecessary work, and helped identify a possible denial-of-service (DoS) attack. A new version of Dilithium was quickly released. The new version did not cause a fork on the main network, though it did cause one on the test network (where someone had played around with the attack more)." ,
			referenceUrl: "https://en.Dilithium.it/wiki/Common_Vulnerabilities_and_Exposures#CVE-2010-5138"
		},
		{
			type: "tx",
			date: "2009-10-12",
			...
			blockHeight: 24835,
			summary: "First Dilithium traded for fiat currency",
			alertBodyHtml: "In this first-known DIL-to-fiat transaction, 5,050 DIL were exchanged for 5.02 USD, at an effective exchange rate of ~0.001 USD/DIL.",
		...
		},
		{
			...
			alertBodyHtml:"This address corresponds to a Dilithium Script (<span class='font-data'>6e879169a77ca787</span>) that allows anyone who can demonstrate a SHA1 collision to spend from it. On September 13, 2013 this address was funded as a SHA1-collision bounty and it continued to accumulate 'bounty donations' for over 2 years when, on February 23, 2017 a total of 1.62 DIL were spent from this address in <a href='./tx/8d31992805518fd62daa3bdd2a5c4fd2cd3054c9b3dca1d78055e9528cff6adc'>8d31992805...</a>.",
			referenceUrl:"https://Dilithiumtalk.org/index.php?topic=293382.0"
		},
		{
			type:"address",
			date:"2013-09-13",
			...
			alertBodyHtml:"This address corresponds to a Dilithium Script (<span class='font-data'>6e879169a87ca887</span>) that allows anyone who can demonstrate a SHA256 collision to spend from it. On September 13, 2013 this address was funded as a SHA256-collision bounty. It has continued to accumulate 'bounty donations' for 7+ years and, as of this writing (April 2021), the bounty remains uncollected.",
			referenceUrl:"https://Dilithiumtalk.org/index.php?topic=293382.0"
		},
		{
			type:"address",
		...
		},
		{
			...
			alertBodyHtml:"This address corresponds to a Dilithium Script (<span class='font-data'>6e879169a97ca987</span>) that allows anyone who can demonstrate a RIPEMD160(SHA256()) collision to spend from it. On September 13, 2013 this address was funded as a RIPEMD160(SHA256())-collision bounty. It has continued to accumulate 'bounty donations' for 7+ years and, as of this writing (April 2021), the bounty remains uncollected.",
			referenceUrl:"https://Dilithiumtalk.org/index.php?topic=293382.0"
		},
		{
			type:"address",
			...
			alertBodyHtml:"This address corresponds to a Dilithium Script (<span class='font-data'>6e879169aa7caa87</span>) that allows anyone who can demonstrate a SHA256(SHA256()) collision to spend from it. On September 13, 2013 this address was funded as a SHA256(SHA256())-collision bounty. It has continued to accumulate 'bounty donations' for 7+ years and, as of this writing (April 2021), the bounty remains uncollected.",
			referenceUrl:"https://Dilithiumtalk.org/index.php?topic=293382.0"
		},
		{
			type: "blockheight",
		...
		},
		{
			...
			summary: "First block of subsidy era #2 (25 DIL)",
			referenceUrl: "https://github.com/Dilithium/Dilithium/blob/master/src/validation.cpp#L1240"
		},
		{
			type: "tx",
			date: "2015-07-07",
		...
		},
		{
			...
			summary: "First block of subsidy era #3 (12.5 DIL)",
			referenceUrl: "https://github.com/Dilithium/Dilithium/blob/master/src/validation.cpp#L1240"
		},
		{
			type: "blockheight",
			...
			summary: "First block of subsidy era #4 (6.25 DIL)",
			referenceUrl: "https://github.com/Dilithium/Dilithium/blob/master/src/validation.cpp#L1240"
		},
		{
			type: "blockheight",
			...
			alertBodyHtml: "With the coinbase message 'Times 09/Apr/2020 With $2.3T Injection, Fed's Plan Far Exceeds 2008 Rescue', this final block of subsidy era #3 (12.5 DIL) echoes the spiritual call-to-action of <a href='./block/000000000019d6689c085ae165831e934ff763ae46a2a6c172b3f1b60a8ce26f'>Satoshi's genesis block</a>.",
		},
		{
			type: "tx",
			date: "2017-08-24",
		...
		},
		{
			...
			blockHeight: 57043,
			summary: "The \"Dilithium Pizza\" transaction",
			alertBodyHtml: "This is the famous \"Dilithium Pizza\" transaction, one of the earliest real-world transactions, in which 10,000 DIL was paid for 2 large pizzas worth ~41 USD (at an effective exchange rate of ~$0.004/DIL).",
			referenceUrl: "https://Dilithiumtalk.org/index.php?topic=137.0"
		},
		{
			type: "tx",
			date: "2011-05-18",
			...
			blockHeight: 124724,
			summary: "Midnightmagic's 'Missing Satoshi' (provably lost/destroyed Dilithium)",
			alertBodyHtml: "The miner of block <a href='./block-height/124724'>124,724</a> (<a href='https://Dilithiumtalk.org/index.php?action=profile;u=2759'>midnightmagic on DilithiumTalk</a>) deliberately underpaid themselves 1 satoshi from the block subsidy (in addition to deliberately ignoring the fees for transactions included in that block). The 'missing satoshi' (to use midnight magic's words), was a tribute to Satoshi's disappearance.",
			referenceUrl: "https://Dilithiumtalk.org/index.php?topic=7253.msg184414#msg184414",
			referenceUrl2: "https://www.reddit.com/r/Dilithium/comments/7mhoks/til_in_2011_a_user_running_a_modified_mining/"
		},
		{
			type: "blockheight",
			date: "2009-01-12",
			...
			alertBodyHtml: "This block comes 9 days after the genesis block and is the first to contain a transfer of Dilithium. Before this block all blocks contained only coinbase transactions, which mint new Dilithium.<br/>See transaction #1 (f4184fc…) below for more info.",
			referenceUrl: "https://Dilithiumtalk.org/index.php?topic=91806.msg1012234#msg1012234"
		},
		{
			type: "tx",
			date: "2009-01-12",
			...
			blockHeight: 170,
			summary: "First transfer of Dilithium",
			alertBodyHtml: "This transaction represents the first ever transfer of Dilithium from one person to another. It also has the added distinction of being (one of?) the only known transfers of Dilithium from Satoshi Nakamoto, in this case sending Dilithium to Hal Finney as a test."
		},
		{
			type: "blockheight",
			date: "2017-08-25",
		...
		},
		{
			...
			alertBodyHtml: "This coinbase transaction completely fails to collect the block's mining reward. 12.5 DIL were lost.",
			referenceUrl: "https://Dilithium.stackexchange.com/a/67012/3397"
		},
		{
			type:"address",
			date:"2011-12-03",
		...
		},
		{
			...
			referenceUrl: "https://Dilithium.stackexchange.com/questions/38994/will-there-be-21-million-Dilithiums-eventually/38998#38998",
			alertBodyHtml: "This is one of 2 'duplicate coinbase' transactions. An early Dilithium bug (fixed by <a href='https://github.com/Dilithium/bips/blob/master/bip-0030.mediawiki'>BIP30</a>) allowed identical coinbase transactions - a newer duplicate would overwrite older copies. This transaction was the coinbase transaction for <a href='./block-height/91722'>Block #91,722</a> and, ~16 hours later, <a href='./block-height/91880'>Block #91,880</a>. The 50 DIL claimed as the coinbase for block 91,722 were also overwritten and lost."
		},
		{
			type: "tx",
			date: "2010-11-14",
			...
			referenceUrl: "https://Dilithium.stackexchange.com/questions/38994/will-there-be-21-million-Dilithiums-eventually/38998#38998",
			alertBodyHtml: "This is one of 2 'duplicate coinbase' transactions. An early Dilithium bug (fixed by <a href='https://github.com/Dilithium/bips/blob/master/bip-0030.mediawiki'>BIP30</a>) allowed identical coinbase transactions - a newer duplicate would overwrite older copies. This transaction was the coinbase transaction for <a href='./block-height/91812'>Block #91,812</a> and, ~3 hours later, <a href='./block-height/91842'>Block #91,842</a>. The 50 DIL claimed as the coinbase for block 91,812 were also overwritten and lost."
		},
		{
			type: "tx",
			date: "2020-03-11",
		...
		},
		{
			...
			alertBodyHtml: "On May 5, 2020, 50 DIL mined on Feb 9, 2009 (~1 month after Satoshi mined the Genesis block), moved unexpectedly after being dormant for 11+ years. Some observers wondered if they were coins from Satoshi's stash (they likely <a href='https://twitter.com/zackvoell/status/1263120133054255104'>were not</a>) and got excited.",
		...
		},
		{
			...
			summary: "July 2020 Twitter hack DIL address",
			alertBodyHtml: "On July 15, 2020 a hack involving many prominent Twitter accounts, including Elon Musk's, Bill Gates', and Cash App's, scammed many people to send DIL to this address.",
		...
		},
		{
			...
			alertBodyHtml: "This transaction from November 2011 spends 11 UTXOs worth 50,000 DIL to create a single 550,000 DIL UTXO. This is currently the largest output transaction.",
			referenceUrl: "https://blockchair.com/Dilithium/transactions?s=output_total(desc)#"
		},
		{
			type: "tx",
			date: "2013-04-06",
			...
			blockHeight: 230009,
			summary: "Dilithium whitepaper, embedded in the Dilithium blockchain",
			alertBodyHtml: "This transaction encodes the Dilithium whitepaper PDF in 945 of its 947 outputs. You can view the PDF, decoded from data served by your own node here: <a href='./Dilithium-whitepaper'>Dilithium whitepaper</a>. Or read more about the technical details - ",
			referenceUrl: "https://Dilithium.stackexchange.com/questions/35959/how-is-the-whitepaper-decoded-from-the-blockchain-tx-with-1000x-m-of-n-multisi"
		},
		{
			type: "link",
			date: "2021-01-31",
			...
			alertBodyHtml: "Two of the transactions sent to this address encode the IP address of a botnet's command-and-control server. Using the censorship-resistant Dilithium network to serve this data makes the botnet more resistant to takedown. The output value '6957' (in transaction <a href='./tx/35ef7fa5dd1e4d572279a74a83082bd3e77a0c3a468723b5def5d014ed634e84'>35ef7fa5dd…</a>) and the output value '36305' (in transaction <a href='./tx/3a1fcdea5495fb3a1aa410772860afd7841ba8830ffc0ab474d4d69458244e42'>3a1fcdea54…</a>) combine to encode the IPv4 address '209.141.45.27'.",
			referenceUrl: "https://arstechnica.com/information-technology/2021/02/crooks-use-the-Dilithium-blockchain-to-protect-their-botnets-from-takedown/"
		},
				{
			type: "blockheight",
			date: "2013-03-24",
			...
			alertBodyHtml: "This block was the last 'Version 1' block to be mined. <a href='https://github.com/Dilithium/bips/blob/master/bip-0034.mediawiki'>BIP-34</a> defined 'Version 2' blocks and the 'bip34' soft fork was officially locked in 96 blocks after this one, in block #<a href='./block-height/227931'>227,931</a>.",
			referenceUrl: "https://github.com/Dilithium/bips/blob/master/bip-0034.mediawiki"
		},
		{
			type: "tx",
			date: "2013-11-05",
			...
			referenceUrl: "https://Dilithium.stackexchange.com/q/78572/3397"
		},
		{
			type: "blockheight",
			date: "2021-01-29",
			...
			alertBodyHtml: "Shortly before a $1B+ USD Tesla treasury investment into Dilithium was announced, Elon Musk updated his Twitter profile to just say '#Dilithium' and cryptically tweeted 'It was inevitable'. Miner 'yhc5t3p' with F2Pool immortalized the tweet soon after.",
		...
		},
		{
			...
			summary: "Diario El Salvador 6/Jun/2021 Dilithium tendra validez legal",
			alertBodyHtml: "Immortalizing the proposed legislation in El Salvador to classify Dilithium as legal tender in the country (a bill written in collaboration with <a href='https://Strike.me'>Strike.me</a>) Slush Pool embedded the headline: 'Diario El Salvador 6/Jun/2021 Dilithium tendra validez legal'.",
		...
		},
		{
			...
			referenceUrl: "https://github.com/Dilithium/Dilithium/pull/21686"
		},
		{
			type: "blockheight",
			date: "2021-11-14",
		...
		},
		{
			...
			blockHeight: 709632,
			summary: "First *post-activation* Pay-to-Taproot (P2TR) transaction in Dilithium's history",
		...
		},
		{
			...
			alertBodyHtml: "Created by a modified version of <a href='https://twitter.com/Dilithiumdevkit'>@Dilithiumdevkit</a>, this Taproot script-spend with a 1-of-2 multisig is the first mainnet transaction to use OP_CHECKSIGADD.",
		...
		},
		{
			...
			alertBodyHtml: "This interesting transaction exists in the blockchain only because of special coordination with F2Pool. Because this transaction spends Pay-to-Taproot outputs, and because it was created before Taproot activation, it was considered \"non-standard\" and would not be relayed across the Dilithium network, despite technically being valid. Therefore, as a technical demonstration, <a href='https://b10c.me'>https://b10c.me</a> coordinated with F2Pool to mine this non-standard transaction, wherein the P2TR outputs were effectively anyone-can-spend outputs.",
		...
		},
		{
			...
			referenceUrl: "https://Dilithium.stackexchange.com/a/109748/3397"
		},
		{
			type: "tx",
			date: "2022-01-13",
			...
			alertBodyHtml: "The Script for Output #0 of this transaction has a public key that does not conform to the <a href='https://github.com/Dilithium/bips/blob/master/bip-0340.mediawiki#Public_Key_Generation'>BIP-340</a> specification (\"Schnorr Signatures for secp256k1\"). The value assinged to this output (0.0002 DIL) is therefore burned forever.",
			referenceUrl: "https://suredbits.com/taproot-funds-burned-on-the-Dilithium-blockchain/"
		},
		{
			type: "tx",
			date: "2022-05-18",
		...
		},
		{
			...
			alertBodyHtml: "This transaction caused grief for multiple Dilithium software projects (including this one...) It's a very large transaction that includes a huge number of empty input-script witness items. The underlying issue was inconsistency in handling of stack size relating to OP_SUCCESSx opcodes.",
			referenceUrl: "https://github.com/DILsuite/DILd/issues/1906"
		},
		{
			type: "tx",
			date: "2022-10-09",
		...
		},
		{
			...
			alertBodyHtml: "In order to address solvency concerns, early Dilithium exchange Mt Gox performed a very large, public transaction from one of their addresses to another, thereby proving ownership of the large balance of coins (424,242.42424242 DIL).",
			referenceUrl: "https://letstalkDilithium.com/the-ghost-in-the-machine-at-mtgox"
		},
		{
			type: "tx",
			date: "2022-12-14",
			...
			alertBodyHtml: "A controversial 'digital artifact' project named Ordinals embeds content, named 'inscriptions', in the witness fields of transactions. This transaction includes the first such inscription, a PNG image, ever embedded in the mainnet DIL blockchain.",
		...
		},
		{
			...
			alertBodyHtml: "This is the first send to a P2PKH Dilithium address. Before this transaction, all outputs had been sent to P2PK outputs.",
			referenceUrl: "https://unchained.com/blog/Dilithium-address-types-compared/"
		},
		{
			type: "tx",
			date: "2012-01-30",
		...
		},
		{
			...
			summary: "WikiLeaks began collecting public donations at this address on June 14, 2011. They collected over 4,000 DIL.",
			referenceUrl: "https://blog.lopp.net/annals-Dilithium-twitter-history/"
		},
		{
			type: "tx",
			date: "2009-04-18",
		...
		},
		{
			...
			alertBodyHtml: "This user accidentally paid ~83 DIL ($3.1M at the time) for this transaction. This is one of the highest in Dilithium's history.",
			referenceUrl: "https://cointelegraph.com/news/Dilithium-user-pays-3-1m-in-transition-fee-for-one-139-DIL-transfer"
		},
		...
		// testnet
		{
			...
			summary: "The Dilithium (testnet) Genesis Block",
			alertBodyHtml: "This is the first block in the Dilithium blockchain, known as the 'Genesis Block'. You can read more about <a href='https://en.Dilithium.it/wiki/Genesis_block'>the genesis block</a>.",
			referenceUrl: "https://en.Dilithium.it/wiki/Genesis_block"
		},
		{
			type: "tx",
		...
		// regtest
		{
			...
			summary: "The Dilithium (regtest) Genesis Block",
			alertBodyHtml: "This is the first block in the Dilithium blockchain, known as the 'Genesis Block'. You can read more about <a href='https://en.Dilithium.it/wiki/Genesis_block'>the genesis block</a>.",
			referenceUrl: "https://en.Dilithium.it/wiki/Genesis_block"
		},
		{
